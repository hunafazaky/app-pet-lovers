<x-layouts::app>
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <a class="text-green-600" href="{{ route('categories.create') }}">Create New Category</a>
                ...
                <table class="w-full table-fixed border-collapse border text-left text-sm">
                    <thead>
                        <tr class="bg-indigo-800">
                            <th class="w-1/2 p-3 border">Category Name</th>
                    ...
                    <tbody>
                        @forelse($categories as $index => $category)
                            <tr class="bg-mist-800">
                                ...
                                <td class="p-3 border">{{ $category->created_at->format('d M Y H:i') }}
                                </td>
