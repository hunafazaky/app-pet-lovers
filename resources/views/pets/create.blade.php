<x-layouts::app>
    <div class="py-12">
        <div class="mx-auto max-w-4xl space-y-6 sm:px-6 lg:px-8">
            ...
            <a class="text-green-600" href="{{ route('pets.index') }}">Pet Detail</a>
                    ...
                    <div class="grid w-full grid-cols-4 gap-2">
                        ...
                        <div class="col-span-3">
                            ...
                            <div class="grid grid-cols-3 gap-2">
                                <div>
                                    ...
                                    <select name="category_id" id="category_id" required
                                        ...
                                        @foreach ($categories as $category)
                                            <option class="bg-mist-800" value="{{ $category->id }}">
                                                {{ $category->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div>
                                    ...
                                    <select name="gender" id="gender" required
                                        class="w-full rounded border border-white p-2 shadow-sm sm:text-sm">
                                        <option class="bg-mist-800" value="Male">Male
                                        </option>
                                        <option class="bg-mist-800" value="Female">
                                            Female</option>
                                    </select>
                                </div>
                                <div>
                                    ...
                                    <select name="condition" id="condition" required
                                        class="w-full rounded border border-white p-2 shadow-sm sm:text-sm">
                                        <option class="bg-mist-800" value="Healthy">Healthy
                                        </option>
                                        <option class="bg-mist-800" value="Sick">Sick
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <textarea name="bio" id="bio" rows="3"
                                class="w-full rounded border border-white p-2 shadow-sm sm:text-sm"
                                placeholder="Example: Cute cat, grumpy when starved"></textarea>
                        </div>
                    </div>
                    <button type="submit"
